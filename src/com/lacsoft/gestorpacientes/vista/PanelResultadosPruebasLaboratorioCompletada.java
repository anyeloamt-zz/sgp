...
public class PanelResultadosPruebasLaboratorioCompletada extends JPanel {
	...
	public PanelResultadosPruebasLaboratorioCompletada() {
		...
		btnEntregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fila >= 0) {
					...
					JOptionPane
							.showMessageDialog(
									PanelResultadosPruebasLaboratorioCompletada.this,
									"Debe seleccionar un paciente para entregar resultado",
									"Gestor Pacientes",
