...
public class PanelPacienteResultados extends JPanel {
	...
	public PanelPacienteResultados() {
		...
		tablaResultados.setModel(ModeloPacienteResultado.getInstancia());
					...
					public void valueChanged(ListSelectionEvent arg0) {
						...
						if (fila >= 0) {
							txtNombre.setText(String
									.valueOf(ModeloPacienteResultado
