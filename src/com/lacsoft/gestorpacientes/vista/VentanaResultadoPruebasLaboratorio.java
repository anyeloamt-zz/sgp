...
public class VentanaResultadoPruebasLaboratorio extends JFrame {

	private static final long serialVersionUID = 1L;
	
	private ImageIcon iconMantenimientos, banner;
	private JTabbedPane tabMantenimientos;
	private static VentanaResultadoPruebasLaboratorio instancia;
	private FactoriaDeJTabbedPane factoriaJtabbed;

	public static synchronized VentanaResultadoPruebasLaboratorio getInstancia() {
		if (instancia == null)
			instancia = new VentanaResultadoPruebasLaboratorio();
		return instancia;
	}

	private VentanaResultadoPruebasLaboratorio() {
